...
class Apptha_Homeplace_Block_Adminhtml_Homeplace_Adedit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            function customize(value){
                var customizeNode=document.getElementById('product_list_customize');
                if(value == 3){
